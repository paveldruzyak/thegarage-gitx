  ...
  module Gitx
    module Cli
      class BuildtagCommand < BaseCommand
        ...
        def buildtag
          fail "Unknown branch. Environment variables TRAVIS_BRANCH, CI_BRANCH or BRANCH_NAME are required" unless branch_name
        ...
        def branch_name
          ENV['TRAVIS_BRANCH'] || ENV['CI_BRANCH'] || ENV['BRANCH_NAME']
        end

        def build_number
          ENV['TRAVIS_BUILD_NUMBER'] || ENV['CI_BUILD_NUMBER'] || ENV['REVISION']
        end
